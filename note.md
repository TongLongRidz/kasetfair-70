...
| 7 | Management | `/admin/management/slip-check` | **ระบบตรวจสอบการชำระเงิน**: อนุมัติ/ปฏิเสธสลิป, ตรวจสอบสลิปเทียบกับยอดเงิน, **ตั้งค่าระบบเปิด/ปิดการให้ผ่านออเดอร์สำหรับ Slip (`slip_upload_mode`: ต้องอัพเลย vs อัพทีหลังได้)** บันทึกลง Database ส่วนกลาง | ✅ **เสร็จแล้ว** |
